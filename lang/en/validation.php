...
return [
    ...
    | versiones como las reglas de tamaño. Siéntete libre de modificar cada uno de
    | estos mensajes aquí.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Aquí puedes especificar mensajes de validación personalizados para atributos utilizando
    | la convención "attribute.rule" para nombrar las líneas. Esto facilita
    | especificar una línea de lenguaje personalizada para una regla de atributo específica.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Las siguientes líneas de lenguaje se utilizan para intercambiar nuestro marcador de posición de
    | atributo con algo más amigable para el lector, como "Dirección de Correo Electrónico"
