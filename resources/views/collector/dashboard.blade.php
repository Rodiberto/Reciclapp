    ...
    <div class="flex h-screen">
        ...
        <div class="p-2 flex-1 bg-gray-100">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6 mt-4 mb-6 py-2">
                ...
                <div class="bg-white overflow-hidden shadow-lg sm:rounded-lg">
                    <div class="p-6 text-gray-900">
                        <p class="flex justify-start items-center text-sm font-semibold text-gray-800">Solicitudes
                            recientes</p>
                                ...
                                @foreach ($requests as $request)
                                    <div class="flex flex-col items-center bg-gray-50 rounded-lg p-4 hover:bg-gray-100">
                                        <div class="text-center text-sm">
                                            ...
                                            <p class="text-gray-600">{{ $request['total_weight'] }} kg</p>
                                        </div>
                                    </div>
                                @endforeach
                            @endif
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-4">
                            ...
                            @else
                                @foreach ($history as $record)
                                    <div class="flex flex-col items-center bg-gray-50 rounded-lg p-4 hover:bg-gray-100">
                                        <div class="text-center text-sm">
                                            <p class="font-semibold text-gray-800">{{ $record['request_code'] }}</p>
                                            <p class="text-gray-600">{{ $record['date'] }}</p>
                                            <p class="text-gray-600">{{ $record['weight'] }} kg</p>
                                        </div>
                                    </div>
                                @endforeach
                            @endif
...
{{-- <script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const labels = @json($materialTypes);
        const data = @json($bagCounts);
